...
{
    public partial class dat154_2022_6Context : DbContext
    {
        public dat154_2022_6Context()
        {
        }

        public dat154_2022_6Context(DbContextOptions<dat154_2022_6Context> options)
            : base(options)
        {
        }
